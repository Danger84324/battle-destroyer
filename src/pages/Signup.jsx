...
export default function Signup({ toggleTheme, theme }) {
    ...
    // FIX: Cleanup timer on unmount to prevent memory leaks / state updates on unmounted component
    ...
    const submit = async e => {
        ...
        try {
            ...
            // potentially unmounting the component before navigate fired.
            ...
            // FIX: moved here from outside try/catch so it always runs (like Login does)
            setLoading(false);
        }
    };

    const dark = theme === 'dark';
    const inputCls = `w-full rounded-xl px-4 py-3 text-sm border focus:border-red-500 focus:outline-none focus:ring-2 focus:ring-red-500/30 transition ${dark ? 'bg-gray-800 text-white border-gray-700 placeholder-gray-600'
            ...
            <div className="hidden lg:flex lg:w-5/12 relative bg-gray-900 items-center justify-center overflow-hidden">
                ...
                <div className="relative text-center px-10">
                    <div className="flex justify-center mb-5">
                        <img src="/logo512.png" alt="Battle Destroyer" className="w-[300px] h-[300px] object-contain drop-shadow-lg" />
                    </div>
            ...
            <div className="flex-1 flex items-center justify-center px-4 sm:px-8 py-8 relative overflow-y-auto">
                ...
                <div className="w-full max-w-sm py-4">
                    <div className="lg:hidden text-center mb-6">
                        <div className="inline-flex items-center justify-center w-30 h-30 rounded-2xl mb-3">
