    ...
    return (
        ...
        >
            ...
            <div className="max-w-6xl mx-auto px-4 sm:px-6 py-10">
                        ...
                        <ul className="space-y-2.5">
                            {navLinks.map(({ to, label, icon: Icon }) => (
                                <li key={to}>
                                    <Link
                                        to={to}
                                        className={`flex items-center gap-2.5 text-sm transition-colors ${dark
                ...
                {/* Bottom bar */}
                <div className={`mt-8 pt-6 border-t flex flex-col sm:flex-row items-center justify-between gap-3 ${dark ? 'border-white/[0.05]' : 'border-black/[0.06]'
                    }`}>
